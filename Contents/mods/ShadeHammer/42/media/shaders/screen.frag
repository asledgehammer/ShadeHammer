...
/*
 * Modified to work with ShadeHammer.
 *
 * @author TheIndieStone
 */

layout(location = 51) uniform sampler2D DIFFUSE;

layout(location = 52) uniform float bgl_RenderedTextureWidth; //scene sampler width
layout(location = 53) uniform float bgl_RenderedTextureHeight; //scene sampler height
layout(location = 54) uniform float timer;
layout(location = 55) uniform float timerWrap;
layout(location = 56) uniform vec2 TextureSize;
layout(location = 57) uniform float Zoom;

layout(location = 58) uniform vec3 Light;
layout(location = 59) uniform float LightIntensity;
layout(location = 60) uniform float NightValue; //replaced timeofday.
layout(location = 61) uniform float Exterior;
layout(location = 62) uniform float NightVisionGoggles;
layout(location = 63) uniform float DesaturationVal;
layout(location = 64) uniform vec4 SearchMode;
layout(location = 65) uniform vec4 ScreenInfo;
layout(location = 66) uniform vec4 ParamInfo;
layout(location = 67) uniform vec4 VarInfo;

layout(location = 68) uniform float DrunkFactor;
layout(location = 69) uniform float BlurFactor;
